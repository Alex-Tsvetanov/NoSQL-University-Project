...
\begin{center}
    ...
    {\fontsize{20}{24}\selectfont Разпределена мулти-тенант платформа за управление на конфигурации и политики с версиониране\par}
    ...
    \begin{flushleft}
    Имена на студент: Алекс Цветанов\par
    Факултетен номер: 121222225\par
    Група: 41\par
