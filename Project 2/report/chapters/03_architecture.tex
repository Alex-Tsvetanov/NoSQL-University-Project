...
[AccessControl Error] User with role 'DataAnalyst' denied insert on vehicles.
  -> MongoServerError: not authorized on fleetTracking to execute command
  { insert: "vehicles" }
[AccessControl Error] User with role 'FleetManager' denied insert on 
  telemetry. -> MongoServerError: not authorized on fleetTracking to execute
  command 
  { insert: "telemetry" }
